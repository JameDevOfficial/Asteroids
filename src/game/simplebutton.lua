...
---@return Button
function ButtonManager.new(label, x, y, width, height, toggle, color, pressedColor, toggledColor, font)
...
function Button:setFont(font)
    assert(type(font) == 'string' or type(font) == 'userdata' or (type(font) == 'table' and font.getHeight),
        'Argument "Font" in Button:setFont must be of type string or LÖVE Font userdata')
